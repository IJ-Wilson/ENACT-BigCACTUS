function [mat] = DoBoundaryPlotsBC(fignum,basic,advanced,graphicsuffix)
...
% for the CACTUS case study. It is edited from DoSectionFivePlots from the
% htadelay repository 18Aug22
